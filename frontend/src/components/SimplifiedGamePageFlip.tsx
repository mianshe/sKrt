...
interface SimplifiedGamePageFlipProps {
...
/**
 * Ultra-simple game-style page flip: camera faces content directly,
 * clean flip from right to left with subtle depth.
 * Focused on clarity and natural feel.
 */
const SimplifiedGamePageFlip: React.FC<SimplifiedGamePageFlipProps> = ({
  isPlaying,
  onComplete,
  duration = 1.2,
  currentPage,
  ...
  // Static view: current page with subtle hint
  if (!isPlaying) {
    return (
    ...
    <div className="relative w-full h-full perspective-1200">
      ...
      <motion.div
        ...
        animate={
          isFlipping
            ? {
                opacity: [0, 0, 0.1, 0.3, 0.6, 0.85, 1, 1, 1],
                scale: [0.98, 0.985, 0.99, 1, 1, 1, 1, 1, 1],
                rotateY: [15, 10, 5, 0, 0, 0, 0, 0, 0],
              }
            : {}
        }
        transition={{
      ...
      {/* Current page (upload) - flips away to the left with natural feel */}
      <motion.div
        ...
        animate={
          isFlipping
            ? {
                rotateY: [0, -20, -45, -70, -100, -130, -160, -190, -220],
                opacity: [1, 1, 1, 0.95, 0.85, 0.7, 0.4, 0.1, 0],
                x: [0, -8, -16, -24, -32, -40, -48, -56, -64],
                scale: [1, 0.99, 0.98, 0.97, 0.96, 0.95, 0.94, 0.93, 0.92],
              }
            : {}
        }
        transition={{
          duration,
          ease: [0.22, 0.68, 0.22, 1], // Natural game-like easing
...
export default SimplifiedGamePageFlip;